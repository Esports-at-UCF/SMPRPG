...
public class AdamantiumBlock extends BlockBlueprint implements ICraftable, ISellable {

    public AdamantiumBlock(ItemService itemService, CustomItemType type) {
    ...
    public CraftingRecipe getCustomRecipe() {
        ...
        recipe.setIngredient('a', ItemService.generate(CustomItemType.TITANIUM_INGOT));
    ...
    public int getWorth(ItemStack item) {
        var ingot = itemService.getCustomItem(CustomItemType.ADAMANTIUM_INGOT);
