...
class BronzeChestplate(itemService: ItemService, type: CustomItemType) : BronzeArmorSet(itemService, type),
    IBreakableEquipment {
    ...
    override fun getAttributeModifiers(item: ItemStack?): MutableCollection<AttributeEntry?> {
        return mutableListOf(
            AdditiveAttributeEntry(
                ...
                ItemArmor.getDefenseFromItemType(CustomItemType.BRONZE_CHESTPLATE).toDouble()
            ),
