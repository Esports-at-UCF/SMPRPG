...
public class RoseGoldBlock extends BlockBlueprint implements ICraftable, ISellable {
    ...
    public CraftingRecipe getCustomRecipe() {
        ...
        recipe.setIngredient('r', ItemService.generate(CustomItemType.ROSE_GOLD_INGOT));
    ...
    public int getWorth(ItemStack item) {
        var ingot = itemService.getCustomItem(CustomItemType.ROSE_GOLD_INGOT);
