...
public class TitaniumBow extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public TitaniumBow(ItemService itemService, CustomItemType type) {
