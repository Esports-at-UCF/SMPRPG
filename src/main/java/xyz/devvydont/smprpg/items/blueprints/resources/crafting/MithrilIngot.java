...
public class MithrilIngot extends CustomItemBlueprint implements ISmeltable, ISellable {

    public MithrilIngot(ItemService itemService, CustomItemType type) {
    ...
    public RecipeChoice getIngredient() {
        return new RecipeChoice.ExactChoice(ItemService.generate(CustomItemType.RAW_MITHRIL));
    }
