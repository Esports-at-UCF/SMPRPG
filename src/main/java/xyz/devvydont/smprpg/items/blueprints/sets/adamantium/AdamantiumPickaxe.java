...
public class AdamantiumPickaxe extends CustomAttributeItem implements IBreakableEquipment, ICraftable {

    public static final Tool TOOL_COMP = Tool.tool()
            .addRule(Tool.rule(ToolGlobals.blockRegistry.getTag(BlockTypeTagKeys.MINEABLE_PICKAXE), 7.0f, TriState.TRUE))
            .build();

    public AdamantiumPickaxe(ItemService itemService, CustomItemType type) {
    ...
    public Collection<AttributeEntry> getAttributeModifiers(ItemStack item) {
        return List.of(
                ...
                new AdditiveAttributeEntry(AttributeWrapper.STRENGTH, ItemPickaxe.getPickaxeDamage(CustomItemType.ADAMANTIUM_PICKAXE)),
                ...
                new AdditiveAttributeEntry(AttributeWrapper.MINING_FORTUNE, ToolGlobals.ADAMANTIUM_TOOL_FORTUNE)
        );
    }
