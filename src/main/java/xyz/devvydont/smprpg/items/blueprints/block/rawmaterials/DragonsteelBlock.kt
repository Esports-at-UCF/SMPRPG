...
class DragonsteelBlock(itemService: ItemService, type: CustomItemType) : BlockBlueprint(itemService, type),
    ...
    override fun getCustomRecipe(): CraftingRecipe {
        ...
        recipe.setIngredient('d', generate(CustomItemType.DRAGONSTEEL_INGOT))
    ...
    override fun getWorth(item: ItemStack): Int {
        val ingot = itemService.getCustomItem(CustomItemType.DRAGONSTEEL_INGOT)
