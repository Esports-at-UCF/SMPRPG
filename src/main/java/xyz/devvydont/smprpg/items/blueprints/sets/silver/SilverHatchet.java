...
public class SilverHatchet extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public SilverHatchet(ItemService itemService, CustomItemType type) {
    ...
    @Override
    public int getMaxDurability() { return ToolGlobals.SILVER_TOOL_DURABILITY; }
    ...
    public CraftingRecipe getCustomRecipe() {
        ...
        recipe.setIngredient('c', itemService.getCustomItem(CustomItemType.SILVER_INGOT));
