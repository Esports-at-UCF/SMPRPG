...
class AetheriumDrillBase(itemService: ItemService, type: CustomItemType) : AetheriumAttributeItem(itemService, type),
    ...
    companion object {
        const val ATTR_KEY: String = "aetherium_drill_base"
    }
}
