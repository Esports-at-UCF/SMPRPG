...
public class MithrilBlock extends BlockBlueprint implements ICraftable, ISellable {

    public MithrilBlock(ItemService itemService, CustomItemType type) {
    ...
    public CraftingRecipe getCustomRecipe() {
        ...
        recipe.setIngredient('m', ItemService.generate(CustomItemType.MITHRIL_INGOT));
