...
public class RoseGoldHoe extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public static final Tool TOOL_COMP = Tool.tool()
            .build();

    public RoseGoldHoe(ItemService itemService, CustomItemType type) {
    ...
    public Collection<AttributeEntry> getAttributeModifiers(ItemStack item) {
        return List.of(
                new AdditiveAttributeEntry(AttributeWrapper.STRENGTH, ItemHoe.getHoeDamage(CustomItemType.ROSE_GOLD_HOE)),
                new MultiplicativeAttributeEntry(AttributeWrapper.ATTACK_SPEED, ItemHoe.getHoeAttackSpeedDebuff(CustomItemType.ROSE_GOLD_HOE)),
                new AdditiveAttributeEntry(AttributeWrapper.MINING_SPEED, ToolGlobals.ROSE_GOLD_TOOL_SPEED),
                new AdditiveAttributeEntry(AttributeWrapper.FARMING_FORTUNE, ToolGlobals.ROSE_GOLD_TOOL_FORTUNE)
        );
    }
