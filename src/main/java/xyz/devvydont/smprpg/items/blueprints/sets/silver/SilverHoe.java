...
public class SilverHoe extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public static final Tool TOOL_COMP = Tool.tool()
            .build();

    public SilverHoe(ItemService itemService, CustomItemType type) {
