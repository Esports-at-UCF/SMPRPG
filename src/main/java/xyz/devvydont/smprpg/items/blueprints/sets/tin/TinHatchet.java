...
public class TinHatchet extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public TinHatchet(ItemService itemService, CustomItemType type) {
    ...
    public Collection<AttributeEntry> getAttributeModifiers(ItemStack item) {
        return List.of(
                ...
                new AdditiveAttributeEntry(AttributeWrapper.STRENGTH, ItemSword.getSwordDamage(CustomItemType.TIN_SWORD) - 5),
                new MultiplicativeAttributeEntry(AttributeWrapper.ATTACK_SPEED, AXE_ATTACK_SPEED_DEBUFF),
                new AdditiveAttributeEntry(AttributeWrapper.WOODCUTTING_FORTUNE, ToolGlobals.TIN_TOOL_SPEED * 0.8),
                new AdditiveAttributeEntry(AttributeWrapper.WOODCUTTING_FORTUNE, ToolGlobals.TIN_TOOL_FORTUNE * 0.8),
                new AdditiveAttributeEntry(AttributeWrapper.FARMING_FORTUNE, ToolGlobals.TIN_TOOL_FORTUNE * 0.8)
        );
    }
    ...
    @Override
    public int getMaxDurability() { return ToolGlobals.TIN_TOOL_DURABILITY; }
    ...
    public CraftingRecipe getCustomRecipe() {
        ...
        recipe.setIngredient('c', itemService.getCustomItem(CustomItemType.TIN_INGOT));
