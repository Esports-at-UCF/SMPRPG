...
class AdamantiumIngot(itemService: ItemService, type: CustomItemType) : CustomItemBlueprint(itemService, type),
     ...
     */
    override fun getIngredient(): RecipeChoice { return ExactChoice(generate(CustomItemType.RAW_ADAMANTIUM)) }
     ...
     */
    override fun getCookingTime(): Long { return TickTime.seconds(80) }
