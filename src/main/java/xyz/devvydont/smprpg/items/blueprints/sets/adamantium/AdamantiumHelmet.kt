...
class AdamantiumHelmet(itemService: ItemService, type: CustomItemType) : AdamantiumArmorSet(itemService, type),
    ...
    override fun getAttributeModifiers(item: ItemStack?): MutableCollection<AttributeEntry?> {
        return mutableListOf(
            AdditiveAttributeEntry(
                ...
                ItemArmor.getDefenseFromItemType(CustomItemType.ADAMANTIUM_HELMET).toDouble()
            ),
