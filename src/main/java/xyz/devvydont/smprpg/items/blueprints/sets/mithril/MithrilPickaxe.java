...
public class MithrilPickaxe extends CustomAttributeItem implements IBreakableEquipment, ICraftable {

    public static final Tool TOOL_COMP = Tool.tool()
            .addRule(Tool.rule(ToolGlobals.blockRegistry.getTag(BlockTypeTagKeys.MINEABLE_PICKAXE), 7.0f, TriState.TRUE))
            .build();

    public MithrilPickaxe(ItemService itemService, CustomItemType type) {
    ...
    public Collection<AttributeEntry> getAttributeModifiers(ItemStack item) {
        return List.of(
                ...
                new AdditiveAttributeEntry(AttributeWrapper.STRENGTH, ItemPickaxe.getPickaxeDamage(CustomItemType.MITHRIL_PICKAXE)),
                ...
                new AdditiveAttributeEntry(AttributeWrapper.MINING_FORTUNE, ToolGlobals.MITHRIL_TOOL_FORTUNE)
        );
    }
