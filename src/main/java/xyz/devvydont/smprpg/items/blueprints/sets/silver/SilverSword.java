...
public class SilverSword extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public SilverSword(ItemService itemService, CustomItemType type) {
