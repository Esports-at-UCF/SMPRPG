...
class MithrilPickaxe(itemService: ItemService, type: CustomItemType) : MithrilAttributeItem(itemService, type),
    ...
    override fun getAttributeModifiers(item: ItemStack?): MutableCollection<AttributeEntry?> {
        return mutableListOf(
            ...
            AdditiveAttributeEntry(
                ...
                ItemPickaxe.getPickaxeDamage(CustomItemType.MITHRIL_PICKAXE)
            ),
