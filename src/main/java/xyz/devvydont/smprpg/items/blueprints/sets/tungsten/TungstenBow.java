...
public class TungstenBow extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public TungstenBow(ItemService itemService, CustomItemType type) {
