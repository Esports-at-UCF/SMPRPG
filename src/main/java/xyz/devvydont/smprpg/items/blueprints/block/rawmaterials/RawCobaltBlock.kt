...
class RawCobaltBlock(itemService: ItemService, type: CustomItemType) : BlockBlueprint(itemService, type), ICraftable,
    ISellable {
    ...
    override fun getCustomRecipe(): CraftingRecipe {
        ...
        recipe.setIngredient('c', generate(CustomItemType.RAW_COBALT))
    ...
    override fun getWorth(item: ItemStack): Int {
        val ingot = itemService.getCustomItem(CustomItemType.RAW_COBALT)
