...
public class AbominationHelmet extends AbominationArmorSet implements IBreakableEquipment, ICraftable {

    public AbominationHelmet(ItemService itemService, CustomItemType type) {
    ...
    public Collection<AttributeEntry> getAttributeModifiers(ItemStack item) {
        ...
        attributes.add(new AdditiveAttributeEntry(AttributeWrapper.DEFENSE, 120));
    ...
    public CraftingRecipe getCustomRecipe() {
        return new HelmetRecipe(this, itemService.getCustomItem(CustomItemType.REVILED_VISCERA), generate()).build();
    }
    ...
    public void __onReceiveDamageFromBoss(CustomEntityDamageByEntityEvent event) {
        ...
        if (isBoss) {
            ...
            if (!isItemOfType(living.getEquipment().getHelmet()))
                return;
