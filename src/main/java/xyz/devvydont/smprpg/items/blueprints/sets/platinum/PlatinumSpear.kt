...
class PlatinumSpear(itemService: ItemService, type: CustomItemType) : PlatinumAttributeItem(itemService, type), ICraftable, IBreakableEquipment, IModelOverridden {
