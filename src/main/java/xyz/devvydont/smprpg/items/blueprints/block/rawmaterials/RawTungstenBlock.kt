...
class RawTungstenBlock(itemService: ItemService, type: CustomItemType) : BlockBlueprint(itemService, type),
    ...
    override fun getCustomRecipe(): CraftingRecipe {
        ...
        recipe.setIngredient('t', generate(CustomItemType.RAW_TUNGSTEN))
    ...
    override fun getWorth(item: ItemStack): Int {
        val ingot = itemService.getCustomItem(CustomItemType.RAW_TUNGSTEN)
