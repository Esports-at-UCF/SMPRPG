...
class TungstenSpear(itemService: ItemService, type: CustomItemType) : TungstenAttributeItem(itemService, type), ICraftable, IBreakableEquipment, IModelOverridden {
