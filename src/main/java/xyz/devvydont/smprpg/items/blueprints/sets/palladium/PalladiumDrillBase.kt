...
class PalladiumDrillBase(itemService: ItemService, type: CustomItemType) : PalladiumAttributeItem(itemService, type),
    ...
    companion object {
        const val ATTR_KEY: String = "palladium_drill_base"
    }
}
