...
class BronzeIngot(itemService: ItemService, type: CustomItemType) : CraftEngineBlueprint(itemService, type), ISellable,
    ...
    override fun getCustomRecipe(): CraftingRecipe {
        ...
        recipe.addIngredient(3, generate(Material.COPPER_INGOT))
        recipe.addIngredient(1, generate(CustomItemType.TIN_INGOT))
    ...
    override fun unlockedBy(): MutableCollection<ItemStack?> {
        return mutableListOf(
            ...
            generate(CustomItemType.TIN_INGOT)
        )
    }
