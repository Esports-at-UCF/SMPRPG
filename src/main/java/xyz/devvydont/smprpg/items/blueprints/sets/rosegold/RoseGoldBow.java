...
public class RoseGoldBow extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public RoseGoldBow(ItemService itemService, CustomItemType type) {
