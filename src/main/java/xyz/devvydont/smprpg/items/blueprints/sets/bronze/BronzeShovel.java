...
public class BronzeShovel extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public static final Tool TOOL_COMP = Tool.tool()
            .build();

    public BronzeShovel(ItemService itemService, CustomItemType type) {
