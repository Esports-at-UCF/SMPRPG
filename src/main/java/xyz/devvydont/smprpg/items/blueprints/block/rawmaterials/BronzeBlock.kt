...
class BronzeBlock(itemService: ItemService, type: CustomItemType) : BlockBlueprint(itemService, type), ICraftable,
    ISellable {
    ...
    override fun getCustomRecipe(): CraftingRecipe {
        ...
        recipe.setIngredient('b', generate(CustomItemType.BRONZE_INGOT))
    ...
    override fun getWorth(item: ItemStack): Int {
        val ingot = itemService.getCustomItem(CustomItemType.BRONZE_INGOT)
