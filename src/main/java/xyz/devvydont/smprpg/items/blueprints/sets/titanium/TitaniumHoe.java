...
public class TitaniumHoe extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public static final Tool TOOL_COMP = Tool.tool()
            .build();

    public TitaniumHoe(ItemService itemService, CustomItemType type) {
    ...
    public Collection<AttributeEntry> getAttributeModifiers(ItemStack item) {
        return List.of(
                new AdditiveAttributeEntry(AttributeWrapper.STRENGTH, ItemHoe.getHoeDamage(CustomItemType.TITANIUM_HOE)),
                new MultiplicativeAttributeEntry(AttributeWrapper.ATTACK_SPEED, ItemHoe.getHoeAttackSpeedDebuff(CustomItemType.TITANIUM_HOE)),
                new AdditiveAttributeEntry(AttributeWrapper.MINING_SPEED, ToolGlobals.TITANIUM_TOOL_SPEED),
                new AdditiveAttributeEntry(AttributeWrapper.FARMING_FORTUNE, ToolGlobals.TITANIUM_TOOL_FORTUNE)
        );
    }
