...
class SteelPickaxe(itemService: ItemService, type: CustomItemType) : SteelAttributeItem(itemService, type),
    ...
    override fun getAttributeModifiers(item: ItemStack?): MutableCollection<AttributeEntry?> {
        return mutableListOf(
            ...
            AdditiveAttributeEntry(
                ...
                ItemPickaxe.getPickaxeDamage(CustomItemType.STEEL_PICKAXE)
            ),
