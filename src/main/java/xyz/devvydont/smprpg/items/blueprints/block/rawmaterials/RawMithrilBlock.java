...
public class RawMithrilBlock extends BlockBlueprint implements ICraftable, ISellable {

    public RawMithrilBlock(ItemService itemService, CustomItemType type) {
    ...
    public CraftingRecipe getCustomRecipe() {
        ...
        recipe.setIngredient('m', ItemService.generate(CustomItemType.RAW_MITHRIL));
