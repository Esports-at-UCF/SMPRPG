...
class RawAdamantiumBlock(itemService: ItemService, type: CustomItemType) : BlockBlueprint(itemService, type),
    ...
    override fun getCustomRecipe(): CraftingRecipe {
        ...
        recipe.setIngredient('a', generate(CustomItemType.RAW_ADAMANTIUM))
    ...
    override fun getWorth(item: ItemStack): Int {
        val ingot = itemService.getCustomItem(CustomItemType.RAW_ADAMANTIUM)
