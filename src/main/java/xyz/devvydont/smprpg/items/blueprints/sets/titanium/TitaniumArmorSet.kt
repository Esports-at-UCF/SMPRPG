...
abstract class TitaniumArmorSet(itemService: ItemService, type: CustomItemType) :
    ...
    val armorDurabilityUnit: Int get() = ToolStats.TITANIUM.getArmorUnitDurability().toInt()

    override fun getAssetId(): Key { return key }

    override fun getPowerRating(): Int { return ToolStats.TITANIUM.power }

    open fun getCraftingMaterial(): ItemStack = itemService.getCustomItem(CustomItemType.TITANIUM_INGOT)
    ...
    companion object {
        private val key = Key.key("titanium")
    }
}
