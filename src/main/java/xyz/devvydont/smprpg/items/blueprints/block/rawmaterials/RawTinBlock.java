...
public class RawTinBlock extends BlockBlueprint implements ICraftable, ISellable {
    ...
    public CraftingRecipe getCustomRecipe() {
        ...
        recipe.setIngredient('t', ItemService.generate(CustomItemType.RAW_TIN));
    ...
    public Collection<ItemStack> unlockedBy() {
        return List.of(
                itemService.getCustomItem(CustomItemType.RAW_TIN)
        );
    }

    @Override
    public int getWorth(ItemStack item) {
        var ingot = itemService.getCustomItem(CustomItemType.RAW_TIN);
