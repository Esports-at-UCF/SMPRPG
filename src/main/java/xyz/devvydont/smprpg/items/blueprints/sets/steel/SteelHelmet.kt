...
class SteelHelmet(itemService: ItemService, type: CustomItemType) : SteelArmorSet(itemService, type), ICraftable,
    IBreakableEquipment {
    ...
    override fun getAttributeModifiers(item: ItemStack?): MutableCollection<AttributeEntry?> {
        return mutableListOf(
            AdditiveAttributeEntry(
                ...
                ItemArmor.getDefenseFromItemType(CustomItemType.STEEL_HELMET).toDouble()
            ),
