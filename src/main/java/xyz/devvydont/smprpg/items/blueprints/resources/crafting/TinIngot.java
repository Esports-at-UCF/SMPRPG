...
public class TinIngot extends CustomItemBlueprint implements ISmeltable, ISellable {

    public TinIngot(ItemService itemService, CustomItemType type) {
    ...
    public RecipeChoice getIngredient() {
        return new RecipeChoice.ExactChoice(ItemService.generate(CustomItemType.RAW_TIN));
    }
