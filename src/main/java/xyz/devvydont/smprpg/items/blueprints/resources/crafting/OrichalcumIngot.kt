...
class OrichalcumIngot(itemService: ItemService, type: CustomItemType) : CustomItemBlueprint(itemService, type),
     ...
     */
    override fun getIngredient(): RecipeChoice { return ExactChoice(generate(CustomItemType.RAW_COBALT)) }
     ...
     */
    override fun getCookingTime(): Long { return TickTime.seconds(40) }
    ...
    override val compressor: CompressionStep
        get() = CompressionStep(itemService.getBlueprint(CustomItemType.ORICHALCUM_BLOCK) as ICompressible, 9, 1)
