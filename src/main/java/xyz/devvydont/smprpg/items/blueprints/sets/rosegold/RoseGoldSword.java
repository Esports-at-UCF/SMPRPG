...
public class RoseGoldSword extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public RoseGoldSword(ItemService itemService, CustomItemType type) {
    ...
    public Collection<AttributeEntry> getAttributeModifiers(ItemStack item) {
        return List.of(
                new AdditiveAttributeEntry(AttributeWrapper.STRENGTH, ItemSword.getSwordDamage(CustomItemType.ROSE_GOLD_SWORD)),
