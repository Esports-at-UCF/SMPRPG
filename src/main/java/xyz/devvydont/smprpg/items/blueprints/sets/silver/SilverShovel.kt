...
class SilverShovel(itemService: ItemService, type: CustomItemType) : SilverAttributeItem(itemService, type),
    ...
    override fun getAttributeModifiers(item: ItemStack?): MutableCollection<AttributeEntry?> {
        return mutableListOf(
            ...
            AdditiveAttributeEntry(AttributeWrapper.STRENGTH, ItemShovel.getShovelDamage(CustomItemType.SILVER_SHOVEL)),
