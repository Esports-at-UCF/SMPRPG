...
public class MithrilSword extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public MithrilSword(ItemService itemService, CustomItemType type) {
