...
class BoilingIngot(itemService: ItemService, type: CustomItemType) : CustomItemBlueprint(itemService, type), ISmeltable,
     ...
     */
    override fun getIngredient(): RecipeChoice { return ExactChoice(generate(CustomItemType.ENCHANTED_IRON)) }
     ...
     */
    override fun getCookingTime(): Long { return TickTime.minutes(10) }
