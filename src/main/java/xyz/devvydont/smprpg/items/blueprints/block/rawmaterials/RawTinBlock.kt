...
class RawTinBlock(itemService: ItemService, type: CustomItemType) : BlockBlueprint(itemService, type), ICraftable,
    ISellable {
    ...
    override fun getCustomRecipe(): CraftingRecipe {
        ...
        recipe.setIngredient('t', generate(CustomItemType.RAW_TIN))
