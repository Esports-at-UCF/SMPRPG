...
public class AdamantiumBow extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public AdamantiumBow(ItemService itemService, CustomItemType type) {
