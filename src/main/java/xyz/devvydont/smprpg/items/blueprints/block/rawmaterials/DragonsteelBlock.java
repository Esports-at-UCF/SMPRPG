...
public class DragonsteelBlock extends BlockBlueprint implements ICraftable, ISellable {
    ...
    public CraftingRecipe getCustomRecipe() {
        ...
        recipe.setIngredient('d', ItemService.generate(CustomItemType.DRAGONSTEEL_INGOT));
    ...
    public int getWorth(ItemStack item) {
        var ingot = itemService.getCustomItem(CustomItemType.DRAGONSTEEL_INGOT);
