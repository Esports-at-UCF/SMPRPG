...
class PlatinumDrillHead(itemService: ItemService, type: CustomItemType) : PlatinumAttributeItem(itemService, type),
    ...
    companion object {
        const val ATTR_KEY: String = "platinum_drill_head"
    }
}
