...
public class BronzeBlock extends BlockBlueprint implements ICraftable, ISellable {
    ...
    public CraftingRecipe getCustomRecipe() {
        ...
        recipe.setIngredient('b', ItemService.generate(CustomItemType.BRONZE_INGOT));
    ...
    public int getWorth(ItemStack item) {
        var ingot = itemService.getCustomItem(CustomItemType.BRONZE_INGOT);
