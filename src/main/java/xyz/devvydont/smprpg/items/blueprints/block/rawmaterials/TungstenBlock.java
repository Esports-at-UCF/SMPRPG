...
public class TungstenBlock extends BlockBlueprint implements ICraftable, ISellable {

    public TungstenBlock(ItemService itemService, CustomItemType type) {
    ...
    public CraftingRecipe getCustomRecipe() {
        ...
        recipe.setIngredient('t', ItemService.generate(CustomItemType.TUNGSTEN_INGOT));
    ...
    public int getWorth(ItemStack item) {
        var ingot = itemService.getCustomItem(CustomItemType.TUNGSTEN_INGOT);
