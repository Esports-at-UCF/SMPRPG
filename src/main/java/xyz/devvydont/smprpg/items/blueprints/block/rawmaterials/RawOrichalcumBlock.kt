...
class RawOrichalcumBlock(itemService: ItemService, type: CustomItemType) : BlockBlueprint(itemService, type),
    ...
    override fun getCustomRecipe(): CraftingRecipe {
        ...
        recipe.setIngredient('o', generate(CustomItemType.RAW_ORICHALCUM))
    ...
    override fun getWorth(item: ItemStack): Int {
        val ingot = itemService.getCustomItem(CustomItemType.RAW_ORICHALCUM)
