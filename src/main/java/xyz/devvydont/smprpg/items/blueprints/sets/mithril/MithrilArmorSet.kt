...
abstract class MithrilArmorSet(itemService: ItemService, type: CustomItemType) :
    ...
    val armorDurabilityUnit: Int get() = ToolStats.MITHRIL.getArmorUnitDurability().toInt()
    ...
    companion object {
        private val key = Key.key("mithril")
    }
}
