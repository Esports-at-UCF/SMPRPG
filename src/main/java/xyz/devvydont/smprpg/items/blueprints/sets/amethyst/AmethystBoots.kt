...
class AmethystBoots(itemService: ItemService, type: CustomItemType) : AmethystArmorSet(itemService, type) {
    ...
    override fun getCustomRecipe(): CraftingRecipe? {
        return BootsRecipe(this, itemService.getCustomItem(CustomItemType.ENCHANTED_AMETHYST), generate()).build()
    }
