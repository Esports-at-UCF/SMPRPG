...
class MithrilLeggings(itemService: ItemService, type: CustomItemType) : MithrilArmorSet(itemService, type),
    ...
    override fun getAttributeModifiers(item: ItemStack?): MutableCollection<AttributeEntry?> {
        return mutableListOf(
            AdditiveAttributeEntry(
                ...
                ItemArmor.getDefenseFromItemType(CustomItemType.MITHRIL_LEGGINGS).toDouble()
            ),
