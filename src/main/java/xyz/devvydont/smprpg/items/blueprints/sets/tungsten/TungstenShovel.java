...
public class TungstenShovel extends CustomAttributeItem implements ICraftable, IBreakableEquipment, IModelOverridden {

    public static final Tool TOOL_COMP = Tool.tool()
            .build();

    public TungstenShovel(ItemService itemService, CustomItemType type) {
    ...
    public Collection<AttributeEntry> getAttributeModifiers(ItemStack item) {
        return List.of(
                new AdditiveAttributeEntry(AttributeWrapper.STRENGTH, ItemShovel.getShovelDamage(CustomItemType.TUNGSTEN_SHOVEL)),
