...
public class AbominationBoots extends AbominationArmorSet implements IBreakableEquipment, ICraftable {

    public AbominationBoots(ItemService itemService, CustomItemType type) {
    ...
    public Collection<AttributeEntry> getAttributeModifiers(ItemStack item) {
        ...
        attributes.add(new AdditiveAttributeEntry(AttributeWrapper.DEFENSE, 110));
    ...
    public CraftingRecipe getCustomRecipe() {
        return new BootsRecipe(this, itemService.getCustomItem(CustomItemType.REVILED_VISCERA), generate()).build();
    }
    ...
    public void __onReceiveDamageFromBoss(CustomEntityDamageByEntityEvent event) {
        ...
        if (isBoss) {
            ...
            if (!isItemOfType(living.getEquipment().getBoots()))
                return;
