...
public class AdamantiumIngot extends CustomItemBlueprint implements ISmeltable, ISellable {

    public AdamantiumIngot(ItemService itemService, CustomItemType type) {
    ...
    public RecipeChoice getIngredient() {
        return new RecipeChoice.ExactChoice(ItemService.generate(CustomItemType.RAW_ADAMANTIUM));
    }
