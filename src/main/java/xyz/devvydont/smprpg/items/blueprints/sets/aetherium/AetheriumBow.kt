...
class AetheriumBow(itemService: ItemService, type: CustomItemType) : AetheriumAttributeItem(itemService, type),
    ...
    override fun getAttributeModifiers(item: ItemStack?): MutableCollection<AttributeEntry?>? {
        return mutableListOf(
            AdditiveAttributeEntry(AttributeWrapper.STRENGTH, ItemSword.getSwordDamage(CustomItemType.AETHERIUM_SWORD))
        )
    }
