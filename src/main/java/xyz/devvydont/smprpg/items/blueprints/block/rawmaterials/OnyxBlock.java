...
public class OnyxBlock extends BlockBlueprint implements ICraftable, ISellable {

    public OnyxBlock(ItemService itemService, CustomItemType type) {
    ...
    public CraftingRecipe getCustomRecipe() {
        ...
        recipe.setIngredient('o', ItemService.generate(CustomItemType.ONYX));
