...
class HalvedSquash(itemService: ItemService, type: CustomItemType) : CraftEngineBlueprint(itemService, type), IEdible,
    ISellable {
    ...
    override fun getSaturation(item: ItemStack?): Float { return 10f }
