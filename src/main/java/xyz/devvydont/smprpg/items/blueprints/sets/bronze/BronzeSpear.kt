...
class BronzeSpear(itemService: ItemService, type: CustomItemType) : BronzeAttributeItem(itemService, type), ICraftable, IBreakableEquipment, IModelOverridden {
    ...
    companion object {
        val KINETIC_COMP : KineticWeapon = KineticWeapon.kineticWeapon()
            .dismountConditions(KineticWeapon.condition(70, 11.0f, 0.0f))
