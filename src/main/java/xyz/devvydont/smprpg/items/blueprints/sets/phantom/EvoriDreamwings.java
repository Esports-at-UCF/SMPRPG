...
public class EvoriDreamwings extends CustomAttributeItem implements IBreakableEquipment, ICraftable, IRepairable {

    @Override
    public @NotNull Collection<@NotNull ItemStack> getRepairMaterial() {
        return List.of(itemService.getCustomItem(CustomItemType.ENCHANTED_MEMBRANE));
    }
