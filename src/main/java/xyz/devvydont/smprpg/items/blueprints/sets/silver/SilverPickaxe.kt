...
class SilverPickaxe(itemService: ItemService, type: CustomItemType) : SilverAttributeItem(itemService, type),
    IBreakableEquipment {
    ...
    override fun getAttributeModifiers(item: ItemStack?): MutableCollection<AttributeEntry?> {
        return mutableListOf(
            ...
            AdditiveAttributeEntry(
                ...
                ItemPickaxe.getPickaxeDamage(CustomItemType.SILVER_PICKAXE)
            ),
