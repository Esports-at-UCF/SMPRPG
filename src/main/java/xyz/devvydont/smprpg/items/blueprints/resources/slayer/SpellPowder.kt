...
class SpellPowder(itemService: ItemService, type: CustomItemType) :
    ...
    override val compressor: CompressionStep? get() = when (customItemType) {
        CustomItemType.SPELL_POWDER ->
            CompressionStep(itemService.getBlueprint(CustomItemType.PREMIUM_SPELL_POWDER) as ICompressible, 9, 1)
        else -> null
    }

    override fun getWorth(itemStack: ItemStack): Int = 75 * itemStack.amount
