...
public class TitaniumIngot extends CustomItemBlueprint implements ISmeltable, ISellable {

    public TitaniumIngot(ItemService itemService, CustomItemType type) {
    ...
    public RecipeChoice getIngredient() {
        return new RecipeChoice.ExactChoice(ItemService.generate(CustomItemType.RAW_TITANIUM));
    }
