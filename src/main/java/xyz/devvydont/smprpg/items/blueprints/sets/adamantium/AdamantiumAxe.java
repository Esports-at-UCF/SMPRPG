...
public class AdamantiumAxe extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public static final Tool TOOL_COMP = Tool.tool()
            .build();

    public AdamantiumAxe(ItemService itemService, CustomItemType type) { super(itemService, type); }
    ...
    public Collection<AttributeEntry> getAttributeModifiers(ItemStack item) {
        return List.of(
                ...
                new AdditiveAttributeEntry(AttributeWrapper.LUMBERING, ItemAxe.getAxeLumbering(CustomItemType.ADAMANTIUM_AXE))
        );
    }
