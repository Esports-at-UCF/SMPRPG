...
class TinChestplate(itemService: ItemService?, type: CustomItemType?) : TinArmorSet(itemService, type), IBreakableEquipment, ICraftable {
    ...
    override fun getAttributeModifiers(item: ItemStack?): MutableCollection<AttributeEntry?> {
        return mutableListOf(
            AdditiveAttributeEntry(
                ...
                ItemArmor.getDefenseFromItemType(CustomItemType.TIN_CHESTPLATE).toDouble()
            ),
    ...
    override fun getCustomRecipe(): CraftingRecipe? {
        return ChestplateRecipe(this, itemService.getCustomItem(CustomItemType.TIN_INGOT), generate()).build()
    }
