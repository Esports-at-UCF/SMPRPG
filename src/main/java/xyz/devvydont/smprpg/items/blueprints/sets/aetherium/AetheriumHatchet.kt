...
class AetheriumHatchet(itemService: ItemService, type: CustomItemType) : AetheriumAttributeItem(itemService, type),
    ...
    override fun getAttributeModifiers(item: ItemStack?): MutableCollection<AttributeEntry?>? {
        return mutableListOf(
            ...
            AdditiveAttributeEntry(
                ...
                ItemSword.getSwordDamage(CustomItemType.AETHERIUM_SWORD) - 5
            ),
