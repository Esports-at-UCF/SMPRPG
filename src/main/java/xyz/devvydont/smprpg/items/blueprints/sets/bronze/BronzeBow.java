...
public class BronzeBow extends CustomAttributeItem implements ICraftable, IBreakableEquipment {

    public BronzeBow(ItemService itemService, CustomItemType type) {
