...
class PlatinumBow(itemService: ItemService, type: CustomItemType) : PlatinumAttributeItem(itemService, type),
    IBreakableEquipment {
    ...
    override fun getAttributeModifiers(item: ItemStack?): MutableCollection<AttributeEntry?>? {
        return mutableListOf(
            AdditiveAttributeEntry(AttributeWrapper.STRENGTH, ItemSword.getSwordDamage(CustomItemType.PLATINUM_SWORD))
        )
    }
