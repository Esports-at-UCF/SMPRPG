...
class MithrilBoots(itemService: ItemService, type: CustomItemType) : MithrilArmorSet(itemService, type),
    IBreakableEquipment {
    ...
    override fun getAttributeModifiers(item: ItemStack?): MutableCollection<AttributeEntry?> {
        return mutableListOf(
            AdditiveAttributeEntry(
                ...
                ItemArmor.getDefenseFromItemType(CustomItemType.MITHRIL_BOOTS).toDouble()
            ),
