...
public class TungstenDrillHead extends CustomItemBlueprint implements IModularToolComponent {

    public static final String attrKey = "adamantium_drill_head";

    public TungstenDrillHead(ItemService itemService, CustomItemType type) {
