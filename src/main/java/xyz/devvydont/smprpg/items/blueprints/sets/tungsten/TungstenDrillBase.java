...
public class TungstenDrillBase extends CustomItemBlueprint implements IModularToolComponent {

    public static final String attrKey = "adamantium_drill_base";

    public TungstenDrillBase(ItemService itemService, CustomItemType type) {
