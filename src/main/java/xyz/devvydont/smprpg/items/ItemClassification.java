...
public enum ItemClassification {
    ...
    SWORD(ItemTypeTagKeys.ENCHANTABLE_WEAPON, ItemTypeTagKeys.ENCHANTABLE_SHARP_WEAPON, ItemTypeTagKeys.ENCHANTABLE_DURABILITY, ItemTypeTagKeys.ENCHANTABLE_VANISHING, ItemTypeTagKeys.ENCHANTABLE_SWEEPING),
    STAFF(ItemTypeTagKeys.ENCHANTABLE_WEAPON, ItemTypeTagKeys.ENCHANTABLE_SHARP_WEAPON, ItemTypeTagKeys.ENCHANTABLE_DURABILITY, ItemTypeTagKeys.ENCHANTABLE_VANISHING, ItemTypeTagKeys.ENCHANTABLE_SWEEPING),
    ...
    MACE(ItemTypeTagKeys.ENCHANTABLE_WEAPON, ItemTypeTagKeys.ENCHANTABLE_MACE, ItemTypeTagKeys.ENCHANTABLE_DURABILITY, ItemTypeTagKeys.ENCHANTABLE_VANISHING),
    ...
    DRILL(ItemTypeTagKeys.ENCHANTABLE_VANISHING, ItemTypeTagKeys.ENCHANTABLE_MINING, ItemTypeTagKeys.ENCHANTABLE_MINING_LOOT, ItemTypeTagKeys.PICKAXES, ItemTypeTagKeys.SHOVELS),
    SHOVEL(ItemTypeTagKeys.ENCHANTABLE_DURABILITY, ItemTypeTagKeys.ENCHANTABLE_VANISHING, ItemTypeTagKeys.ENCHANTABLE_MINING, ItemTypeTagKeys.SHOVELS),
    SHEARS(ItemTypeTagKeys.ENCHANTABLE_DURABILITY, ItemTypeTagKeys.ENCHANTABLE_VANISHING, ItemTypeTagKeys.ENCHANTABLE_MINING),
    ...
    HELMET(ItemTypeTagKeys.ENCHANTABLE_HEAD_ARMOR, ItemTypeTagKeys.ENCHANTABLE_ARMOR, ItemTypeTagKeys.ENCHANTABLE_DURABILITY, KeyStore.ENCHANTABLE_APTITUDE, ItemTypeTagKeys.ENCHANTABLE_VANISHING),
    CHESTPLATE(ItemTypeTagKeys.ENCHANTABLE_CHEST_ARMOR, ItemTypeTagKeys.ENCHANTABLE_ARMOR, ItemTypeTagKeys.ENCHANTABLE_DURABILITY, KeyStore.ENCHANTABLE_APTITUDE, ItemTypeTagKeys.ENCHANTABLE_VANISHING),
    LEGGINGS(ItemTypeTagKeys.ENCHANTABLE_LEG_ARMOR, ItemTypeTagKeys.ENCHANTABLE_ARMOR, ItemTypeTagKeys.ENCHANTABLE_DURABILITY, KeyStore.ENCHANTABLE_APTITUDE, ItemTypeTagKeys.ENCHANTABLE_VANISHING),
    BOOTS(ItemTypeTagKeys.ENCHANTABLE_FOOT_ARMOR, ItemTypeTagKeys.ENCHANTABLE_DURABILITY, ItemTypeTagKeys.ENCHANTABLE_VANISHING, KeyStore.ENCHANTABLE_APTITUDE, ItemTypeTagKeys.ENCHANTABLE_ARMOR),
    ...
    TOME(KeyStore.ENCHANTABLE_TOME, KeyStore.ENCHANTABLE_APTITUDE),
    REFORGE_STONE,
    MATERIAL,
    ...
    public static ItemClassification resolveVanillaMaterial(@NotNull Material material) {
        ...
        return switch (material) {
            ...
            case DIAMOND_SHOVEL, GOLDEN_SHOVEL, IRON_SHOVEL, NETHERITE_SHOVEL, STONE_SHOVEL, WOODEN_SHOVEL -> SHOVEL;
