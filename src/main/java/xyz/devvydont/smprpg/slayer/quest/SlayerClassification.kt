...
enum class SlayerClassification(val slayerType : SlayerType, val entityType : CustomEntityType, val spawnFlag : String, val xpToSpawn : Int, val cost : Int, val slayerXpReward : Int) {
