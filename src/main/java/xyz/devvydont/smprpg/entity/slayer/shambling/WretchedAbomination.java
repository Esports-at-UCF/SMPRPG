...
public class WretchedAbomination extends CustomEntityInstance<Zombie> {

    public WretchedAbomination(Entity entity, CustomEntityType type) {
        this((Zombie) entity, type);
    }

    public WretchedAbomination(Zombie entity, CustomEntityType entityType) {
        super(entity, entityType);
    }

    public static String HEAD_TEXTURE = "http://textures.minecraft.net/texture/66cfab1d2f763f333b5e1bdcd1ad162c7f12a1ac2224463a144643ec23f98";
    ...
    public @Nullable Collection<LootDrop> getItemDrops() {
        return List.of(
                new QuantityLootDrop(ItemService.generate(CustomItemType.NECROTIC_FLESH), 2, 4, this)
        );
    }

    @Override
    public SkillExperienceReward generateSkillExperienceReward() {
        return SkillExperienceReward.of(SkillType.COMBAT, 2350);
    }
}
