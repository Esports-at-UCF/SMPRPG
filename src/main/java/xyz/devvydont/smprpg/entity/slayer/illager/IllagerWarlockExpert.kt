...
class IllagerWarlockExpert(entity: LivingEntity?, entityType: CustomEntityType?) : IllagerWarlockParent(entity as Evoker?, entityType) {
    override fun getItemDrops(): List<LootDrop> {
        return listOf(
            QuantityLootDrop(generate(CustomItemType.PREMIUM_SPELL_POWDER), 5, 8, this),
            ChancedItemDrop(generate(CustomItemType.ENCHANTED_SPELL_POWDER), 5, this),
            QuantityLootDrop(generate(Material.EMERALD_BLOCK), 4, 7, this),
            ChancedItemDrop(generate(CustomItemType.ENCHANTED_EMERALD), 5, this),

            ChancedItemDrop(LOOT_VIGILANTE_SCROLL, 40, this),
            ChancedItemDrop(LOOT_APTITUDE_SCROLL, 65, this),
            ChancedItemDrop(LOOT_INSIGHT_SCROLL, 100, this),
            ChancedItemDrop(LOOT_BURDEN_SCROLL, 150, this),
            ChancedItemDrop(generate(CustomItemType.CRYSTAL_BALL), 100, this),
    ...
    override fun setup() {
        ...
        mobGoals.addGoal(evoker, 3, IllagerWarlockAuraCloudGoal(this, null, 7.0))
        mobGoals.addGoal(evoker, 3, IllagerWarlockFangChaseGoal(this, null, 15))
        mobGoals.addGoal(evoker, 3, IllagerWarlockSpellGoal(this, null, 24, mapOf(
