...
public class RemorsefulAbomination extends CustomEntityInstance<Zombie> {

    public RemorsefulAbomination(Entity entity, CustomEntityType type) {
        this((Zombie) entity, type);
    }

    public RemorsefulAbomination(Zombie entity, CustomEntityType entityType) {
    ...
    public void setup() {
        ...
        _entity.getEquipment().setChestplate(getAttributelessItem(Material.IRON_CHESTPLATE));
    ...
    public @Nullable Collection<LootDrop> getItemDrops() {
        return List.of(
                new QuantityLootDrop(ItemService.generate(CustomItemType.NECROTIC_FLESH), 3, 7, this)
        );
    }

    @Override
    public SkillExperienceReward generateSkillExperienceReward() {
        return SkillExperienceReward.of(SkillType.COMBAT, 5875);
    }
}
